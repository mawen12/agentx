...
import com.github.mawen12.agent.api.metric.Metric.FieldWrapper;
import com.github.mawen12.agent.api.metric.Metric.SubType;
import com.github.mawen12.agent.api.metric.Metric.Type;
import com.github.mawen12.agent.api.utils.Sets;
import com.github.mawen12.agent.api.utils.Tuple;

import java.util.*;

import static com.github.mawen12.agent.api.metric.Metric.Field.*;
import static com.github.mawen12.agent.api.metric.Metric.FieldWrapper.of;
import static com.github.mawen12.agent.api.metric.Metric.SubType.DEFAULT;
import static com.github.mawen12.agent.api.metric.Metric.SubType.ERROR;
import static com.github.mawen12.agent.api.metric.Metric.ValueFetcher.*;
...
public interface NameFactory {
    ...
    class NameFactoryImpl implements NameFactory {
        ...
        public Map<SubType, MetricName> counterNames(String key) {
            ...
            counters.forEach(t -> results.put(t.getX(), new MetricName(Type.Counter, t.getX(), key, t.getY())));
            return results;
        }
        ...
        public Map<SubType, MetricName> gaugeNames(String key) {
            Map<SubType, MetricName> results = new HashMap<>();
            gauges.forEach(t -> results.put(t.getX(), new MetricName(Type.Gauge, t.getX(), key, t.getY())));
            return results;
        }
        ...
        public Map<SubType, MetricName> histogramNames(String key) {
            Map<SubType, MetricName> results = new HashMap<>();
            histograms.forEach(t -> results.put(t.getX(), new MetricName(Type.Histogram, t.getX(), key, t.getY())));
            return results;
        }
        ...
        public Map<SubType, MetricName> meterNames(String key) {
            Map<SubType, MetricName> results = new HashMap<>();
            meters.forEach(t -> results.put(t.getX(), new MetricName(Type.Meter, t.getX(), key, t.getY())));
            return results;
        }
        ...
        public Map<SubType, MetricName> timerNames(String key) {
            Map<SubType, MetricName> results = new HashMap<>();
            timers.forEach(t -> results.put(t.getX(), new MetricName(Type.Timer, t.getX(), key, t.getY())));
            return results;
        }
