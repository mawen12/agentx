package com.github.mawen12.agentx.core.plugins.log4j2.interceptor.prepare;
...
public class Log4j2PrepareInterceptor implements NonReentrantInterceptor {
    public static Log4j2PrepareInterceptor INSTANCE = new Log4j2PrepareInterceptor();
