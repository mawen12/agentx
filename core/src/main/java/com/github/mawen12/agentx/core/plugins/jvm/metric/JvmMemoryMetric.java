...
public class JvmMemoryMetric extends ServiceMetric implements Runnable {
    ...
    public static void buildAndRun() {
        ...
        JvmMemoryMetric metric = ServiceMetricRegistry.getOrCreate(tags, JvmMemoryNameFactory.INSTANCE.nameFactory(), JvmMemoryMetric::new);
        ScheduleHelper.INSTANCE.execute(10, 10, metric);
    }
